...
public class Startup {
    ...
    public static void main(String[] args) {
        ...
        //TipCalculator calc1 = new FoodServiceTipCalculator(TipService.ServiceQuality.FAIR, 125.00);
        //TipCalculator calc2 = new BaggageServiceTipCalculator(TipService.ServiceQuality.GOOD, 5);
